...
public class GroupDetailsActivity extends BaseActivity implements OnClickListener {
                    ...
                    if (!TextUtils.isEmpty(returnData)) {
                        ...
                        NetDao.updateGroupName(this, groupId, returnData, new OnCompleteListener<String>() {
                            ...
                            public void onSuccess(String result) {
                                Log.e(TAG, "updateGroupName,result=" + result);
                            }
    ...
    private void exitGrop() {
        ...
        NetDao.removeGroupMember(this, groupId, EMClient.getInstance().getCurrentUser(),
                new OnCompleteListener<String>() {
                    @Override
                    public void onSuccess(String result) {
                        Log.e(TAG, "exitGrop,result=" + result);
                    }
    ...
    private void deleteGrop() {
        ...
        NetDao.deleteGroup(this, groupId, new OnCompleteListener<String>() {
            @Override
            public void onSuccess(String result) {
                Log.e(TAG,"deleteGroup,result=" + result);
            }
    ...
    private void addMembersToGroup(final String[] newmembers) {
        ...
        NetDao.addGroupMember(this, getGroupMembers(newmembers), groupId, new OnCompleteListener<String>() {
            @Override
            public void onSuccess(String result) {
                Log.e(TAG, "addGroupMember,result=" + result);
            }
...
//				button.setCompoundDrawables(null, avatar, null, null);
                ...
                button.setOnClickListener(new OnClickListener() {
                    ...
                    protected void deleteMembersFromGroup(final String username) {
                        ...
                        deleteDialog.show();
                        NetDao.removeGroupMember(GroupDetailsActivity.this, groupId, username, new OnCompleteListener<String>() {
                            @Override
                            public void onSuccess(String result) {
